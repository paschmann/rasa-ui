...
function InsightsController($scope, $http, $sce, NLU_Parse_log_request_activeUserCountLast30Days,NLU_Parse_log_request_activeUserCountLast12Months,
                            NLU_Parse_log_request_avgUserResponseTimesLast30Days,NLU_Parse_log_request_avgNluResponseTimesLast30Days,
                          NLU_Parse_log_request_intentsMostUsed, NLU_Parse_log_request_agentsByIntentConfidencePct) {
  //all agentnames
  loadDailyActiveUsers();


NLU_Parse_log_request_avgNluResponseTimesLast30Days.query(function(data) {
  ...
  NLU_Parse_log_request_avgUserResponseTimesLast30Days.query(function(data) {
    var response_data = [];
  ...
  function loadDailyActiveUsers(){
    NLU_Parse_log_request_activeUserCountLast30Days.query(function(data) {
        var users_data = [];
        var avg_act_users=0;
  ...
  function loadMonthlyActiveUsers(){
    NLU_Parse_log_request_activeUserCountLast12Months.query(function(data) {
      var users_data = [];
      var avg_act_users=0;
  ...
  NLU_Parse_log_request_intentsMostUsed.query(function(data) {
    ...
    NLU_Parse_log_request_agentsByIntentConfidencePct.query(function(data) {
