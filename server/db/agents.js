...
function updateAgent(req, res, next) {
  ...
  db.none(
    'update agents set agent_name=$2, endpoint_enabled=$3, endpoint_url=$4, basic_auth_username=$5, basic_auth_password=$6, rasa_core_enabled=$7, rasa_nlu_pipeline=$8, rasa_nlu_fixed_model_name=$9, rasa_nlu_language=$10, rasa_nlu_threshold=$11 where agent_id=$1',
    [
